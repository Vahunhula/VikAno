            ...
            <div className="relative">
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">{t('gallery.spotlight.location', 'Location')}</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{t('gallery.spotlight.cityName', 'Woodwork City')}</p>
                </motion.div>
